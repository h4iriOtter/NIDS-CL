...
LOG_FILE = 'results_NF+Malaya_NaiveBaseline.txt' # [UPDATED] Log file name
...
def main():
    ...
    logger = [
        ...
        WandBLogger( 
            ...
            run_name="NF+Malaya_Run1_NaiveBaseline", # [UPDATED] Differentiates it on your WandB dashboard
