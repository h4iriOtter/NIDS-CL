...
MEM_SIZE = 936    # The size of the Replay Buffer (Memory of past tasks)
...
LOG_FILE = 'results_NF+Malaya_Run1_4GB_256KB.txt' # [UPDATED] Log file name
...
def main():
    ...
    logger = [
        ...
        WandBLogger( 
            ...
            run_name="NF+Malaya_Run1_4GB_256KB", # [UPDATED] Differentiates it on your WandB dashboard
