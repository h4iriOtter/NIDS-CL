...
MEM_SIZE = 1872    # The size of the Replay Buffer (Memory of past tasks)
...
LOG_FILE = 'results_NF+Malaya_Run1_4GB_512KB.txt' # [UPDATED] Log file name
...
def main():
    ...
    logger = [
        ...
        WandBLogger( 
            ...
            run_name="NF+Malaya_Run1_4GB_512KB", # [UPDATED] Differentiates it on your WandB dashboard
