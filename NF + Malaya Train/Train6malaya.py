...
LOG_FILE = 'results_NF+Malaya_Run1_4GB_128KB.txt' # [UPDATED] Log file name
...
def main():
    ...
    logger = [
        ...
        WandBLogger( 
            ...
            run_name="NF+Malaya_Run1_4GB_128KB", # [UPDATED] Differentiates it on your WandB dashboard
