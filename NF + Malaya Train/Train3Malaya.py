...
MEM_SIZE = 3800    # The size of the Replay Buffer (Memory of past tasks)
...
LOG_FILE = 'results_NF+Malaya_Run1_4GB_1MB.txt' # [UPDATED] Log file name
...
def main():
    ...
    logger = [
        ...
        WandBLogger( 
            ...
            run_name="NF+Malaya_Run1_4GB_1MB", # [UPDATED] Differentiates it on your WandB dashboard
